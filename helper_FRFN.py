...
def train_step(model: torch.nn.Module, dataloader: torch.utils.data.DataLoader, loss_fn: torch.nn.Module, optimizer: torch.optim.Optimizer, device):
...
def plot_model_predictions(pred_classes, test_labels, test_samples, class_names):
